...
public class updateInsData extends HttpServlet {

    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        response.setContentType("text/html;charset=UTF-8");
        try {
            String ID, FNAME, LNAME, DOB, SEX, ADDRESS, EMAIL, PHONE, depid;
            ...
            Boolean isvalid = method.updateInsData(con, ID, FNAME, LNAME, DOB, SEX, ADDRESS, EMAIL, PHONE, depid);
